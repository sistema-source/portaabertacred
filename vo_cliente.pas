...
function TVoCliente.LoadFromJsonString(const AJsonString: string): boolean;
var
  JsonData: TJSONData;
  ...
  try
    try // Bloco principal para capturar exceções durante o parsing
      ...
      begin
        ...
        // Ex: OutputDebugString(PChar('Erro ao carregar JSON para TVoCliente: ' + E.Message));
...
function TVoCliente.ToJsonString: string;
var
  JsonObject: TJSONObject;
begin
